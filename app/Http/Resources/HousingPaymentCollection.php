    ...
    public function toArray(Request $request): array
    {
        return $this->collection->map(function ($housing_payment) {
            return [
                ...
                'housing_room' => $housing_payment->housing_room->room_number ?? '000',
                'housing' => $housing_payment->housing_room?->housing->name ?? 'No hay propiedad',
                ...
                'tenancy_identity_document' => $housing_payment->tenancy->identity_document->abbreviation ?? 'Sin documento',
