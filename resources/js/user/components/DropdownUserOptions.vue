  ...
  <DropdownMenu>
    ...
    <DropdownMenuContent align="end">
      ...
      <DialogTrigger class="w-full">
        <DropdownMenuItem @click="updateFormUser" class="flex items-center gap-x-2 text-sky-800 py-2 cursor-pointer">
          <SquarePen class="w-5 h-5" />
          Editar
        </DropdownMenuItem>
      </DialogTrigger>
      <DropdownMenuItem as="a" class="flex items-center gap-x-2 text-red-700 py-2 cursor-pointer" :href="callPerson(user.phone)">
