...
const emit = defineEmits(['update:role-form'])

function updateFormTenancy(): void {
  emit('update:role-form', props.role)
}
...
<template>
  <DropdownMenu>
    ...
    <DropdownMenuContent align="end">
      ...
      <DialogTrigger class="w-full">
        <DropdownMenuItem @click="updateFormTenancy"
  ...
  <RoleDetail :is-drawer-open="isDrawerOpen" :role="role" @update:drawer-state="updateDrawerState" />
</template>
